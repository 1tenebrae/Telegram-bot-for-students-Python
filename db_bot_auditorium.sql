...
CREATE TABLE `auditorium` (
  ...
  `number_class` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `number_class_UNIQUE` (`number_class`)
...
INSERT INTO `auditorium` VALUES (14,'0'),(3,'114С'),(1,'142С'),(5,'204С'),(8,'207С'),(9,'209С'),(4,'212С'),(2,'213С'),(6,'230С'),(7,'327С');
